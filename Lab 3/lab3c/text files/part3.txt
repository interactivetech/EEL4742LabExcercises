...
void OUTA_UART(unsigned char A){
		...
		//Checks if letter is Capital and makes it lower
		char new_case = A;
		if((new_case>64)&(new_case<91))
		{
			new_case=tolower(new_case);
		}
		//makes it uppercase if it's lowercase
		else
			new_case=toupper(new_case);

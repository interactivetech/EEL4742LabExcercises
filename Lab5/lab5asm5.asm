...
StopWDT 	mov.w #WDTPW+WDTHOLD,&WDTCTL ; Stop WDT
			...
			mov.w #0x0000,R13 ; reset flag to print to be zero
...
;  call #uartGetChar
	...
	;;  xor.b #0x41 ,  &P1OUT
			...
			call #INCHAR_UART ; get operation



			mov.w R4, R12 ; store the operation to check
...
Addition:
		...
		mov.b #0xF0,R13 ; INDEX FOR lcd TO PRINT

			add.w R7,R11



			mov.w R11,R9  ;move result to prepare printing
...
Subtraction:		;subtract together

			mov.b #0x00,R13 ; INDEX FOR lcd TO PRINT
			...
			mov.w R7,R9 ; move answer to print
...
SUB1:	sub.w R7,R11
			...
			;flag to determine what to print

			mov.b #0xFF,R13 ; INDEX FOR lcd TO PRINT
			...
			mov.w R11,R9 ; move answer to print
...
Multiply:
	...
	;flag to determine what to print
			...
			mov.b #0xFE,R13 ; INDEX FOR lcd TO PRINT

	cmp.w #0x0000,R11



	jeq PRINT; print if equal to zero, end loop
...
PRINT:	;print the resulting 8 bits
			...
			mov.b R11,R6 ; INDEX FOR lcd TO PRINT

			and.w #0x000F,R6

			call #HEX10UT ;PRINT 4TH HEX
...
PRINT_ADD:
	...
	;mov.b num(R7), R6	   ;send b to LCD memory for display
	...
	mov.b R8 , 1(R5) ; display second character in



	mov.b R7 , 2(R5) ; display third character in



	;mov.b R6 , 3(R5) ; display third character in
...
PRINT_MULT:
	...
	mov.b num(R6), R6	   ;send b to LCD memory for display
